...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">SIAKADU UNILA</a>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Mahasiswa Ilmu Komputer</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="npm" placeholder="Masukkan NPM" min="1" name="npm" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
