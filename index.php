...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary text-uppercase">
        <div class="container">
            ...
            <a class="navbar-brand ms-2" aria-current="page" href="index.php">SIAKADU UNILA</a>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase mt-3">Data Mahasiswa Ilmu Komputer</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
                        ...
                        <?php foreach ($siswa as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="ubah.php?npm=<?= $row['npm']; ?>" class="btn btn-primary btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |
    ...
    <!-- Footer -->
    <footer class="sticky-footer bg-none mt-5">
        <div class="container my-auto mb-3">
            <div class="copyright text-center my-auto">
           <span>Copyright &copy; Ananda Sheva Hidayat 2024</span>
            </div>
        </div>
        </footer>
    <!-- End of Footer -->
