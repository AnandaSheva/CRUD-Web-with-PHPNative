...
<head>
    ...
    <title>Siakadu Unila - Login</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-md-6 text-center login" style="background-image: url('img/bg/pattern.png');">
                ...
                <form action="" method="post">
                    ...
                    <a href="register.php" style="font-family: sans-serif;">Belum Punya Akun? Register</a> <br><br>
